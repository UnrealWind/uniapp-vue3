    ...
    <div  style="height: 85vh;overflow-y: scroll" >
      ...
      <div class="detail-info">
        ...
        <div class="detail-para">
          <h3  class="h3">详细参数</h3>
          <div class="div"><img class="img" mode="widthFix" src="../../../static/img/size.png">尺寸（长*宽*高 mm）<span class="span">1043*978*576</span></div>
          <div class="div"><img class="img" mode="widthFix" src="../../../static/img/weight.png">重量<span class="span">552kg</span></div>
          <div class="div"><img class="img" mode="widthFix" src="../../../static/img/way.png">技术路线<span class="span">DOC+DPF+SCR</span></div>
        </div>
        <div class="scenario">
          <h3  class="h3">适用应用场景</h3>
          <div class="div"><i class="i">履带挖掘机</i><span class="span">20-21T</span><span class="span text-gray-500">标准吨位：</span></div>
...
<!--          <div><i>采棉机</i><span>6</span><span class="text-gray-500">作业行数（行箱式）：</span></div>-->
        ...
        <div class="tec">
          <h3  class="h3">技术特点</h3>
          <rich-text  type="text" :nodes="strs"></rich-text>
        </div>
      </div>
    </div>
