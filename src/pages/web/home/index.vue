      ...
      <div style="padding: 0 200px">
        ...
        <div class="device">
          <div class="device-item" v-for="(item,index) in recommandProductSceneList">
            <img @click="goFilter(item)" mode="widthFix" :src="getImg(`https://uat.cs.cummins.com.cn/doem-h5/static/img-web/device/${item.sceneCode}.png`)" />
...
<script setup>
  ...
  const info = ref([{
      url: 'https://uat.cs.cummins.com.cn/doem-h5/static/img-web/swiper1.png',
      content: '传承经典，洞悉创编/打造面向燃油四阶段，全新系列发动机',
    },
    {
      url: 'https://uat.cs.cummins.com.cn/doem-h5/static/img-web/swiper2.png',
